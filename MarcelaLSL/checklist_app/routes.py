...
from models import ChecklistTemplate, Checklist, ChecklistItemTemplate, ChecklistAnswer, User, Role
...
# A partir de agora, as rotas precisam de um usuário logado
# Ex: @app.route('/')
# @login_required
# def index():
#     ...
...
def register():
    # Em um sistema real, esta rota seria restrita a um administrador
    # Por enquanto, vamos deixá-la aberta para criar um usuário inicial
    if request.method == 'POST':
...
def seed_roles():
    """Rota para popular o DB com perfis iniciais. Apenas para setup inicial."""
...
# A partir daqui, as rotas que dependem de usuário logado
# devem ser protegidas com @login_required
...
# ... (O resto das suas rotas como criar_checklist, preencher_checklist, etc.,
# devem ser protegidas com @login_required. Por enquanto, não precisa alterar
# o conteúdo delas, apenas adicione o decorador.)
